...
public class RetryableAsyncCouchDocFetchTask implements Callable<RetryableAsyncCouchDocFetchTask> {
    ...
    public RetryableAsyncCouchDocFetchTask call() throws Exception {
        try {
            ...
            if (retryCount > MAX_TASK_RETRY) {
                System.out.println(name + " : stopping retryCount :" + retryCount);
                throw new IOException(name + " : stopping due to IOException retryCount :" + retryCount);
            }
